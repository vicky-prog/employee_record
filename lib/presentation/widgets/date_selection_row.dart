...
class DateSelectionRow2 extends StatelessWidget {
  final VoidCallback onFromDateTap;
  final VoidCallback onToDateTap;
  final DateTime? fromDate;
  final DateTime? toDate;
  ...
  Widget build(BuildContext context) {
   ...
   double inputFieldHeight = (screenWidth * 0.10).clamp(40.0, 45.0);
    ...
    double iconSize = (screenWidth * 0.04).clamp(15, 25); // 4% of screen width

    double fontSize = (screenWidth * 0.04).clamp(12, 16); // 4% of screen width
